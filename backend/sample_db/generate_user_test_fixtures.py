...
- 15 digits (starting with 133, e.g., 133280122203291) indicates it was issued by a CSC counter.
...
A: An application without an IGRS Form 6 number indicates it was filed via a CSC counter or directly by a citizen at a revenue camp. Only Sub-Registrar (SRO) referrals carry an IGRS Form 6 number, which is raised automatically off the registered deed. For CSC and citizen channels, an empty IGRS field is the standard rule, not a missing record or data gap.
