...
ITEMS: list[tuple] = [
    ...
    ("Does the CAN number length tell me the submission channel?", "CAN எண் நீளம் சமர்ப்பிப்பு சேனலைச் சொல்லுமா?",
     "land_rules.txt", "no - length names the issuing counter (15 = e-Sevai/133 series, 12 = TN portal), not the channel", "channel"),
    ...
    ("What does an absent IGRS Form 6 number mean?", "IGRS படிவம் 6 எண் இல்லாதது என்ன அர்த்தம்?",
     "land_rules.txt", "the file did not come from the SRO; it was CSC/e-Sevai or a revenue camp - not a gap in the record", "igrs"),
